...
**Awesome Books ES6 version** In this project I refactor my previous Awsome Books project into ES6 syntax, which has the same functionallity like previous one just I have chnaged the stracture of prevoius version with adding Luxon library which shows the current time.
